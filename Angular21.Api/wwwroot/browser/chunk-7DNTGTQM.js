...
var DashboardComponent = class _DashboardComponent {
  ...
  searchCriteriaForm = this.dashboardService.createSearchCriteriaForm(this.getSearchCriteria.value);
  ...
  searchCriteriaValue = this.getSearchCriteria.value;
  async ngOnInit() {
    this.searchCriteriaForm = this.dashboardService.createSearchCriteriaForm(this.getSearchCriteria.value);
  }
  onSearch() {
...
(() => {
  ...
  }], null, { searchCriteria: [{ type: Input, args: [{ isSignal: true, alias: "searchCriteria", required: false }] }, { type: Output, args: ["searchCriteriaChange"] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-7DNTGTQM.js.map
