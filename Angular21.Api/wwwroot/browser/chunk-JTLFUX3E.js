...
var DashboardService = class _DashboardService {
  createSearchCriteriaFormNew(getSearchCriteria) {
    const dataValue = getSearchCriteria.value();
    console.log("Data Value:", dataValue);
    return new FormGroup({
      firstName: new FormControl(dataValue?.firstName || null),
      lastName: new FormControl(dataValue?.lastName || null)
    });
  }
  ...
  createSearchCriteriaForm2() {
    const dataValue = this.getSearchCriteria().value();
    return new FormGroup({
      firstName: new FormControl(dataValue?.firstName || null),
      lastName: new FormControl(dataValue?.lastName || null)
    });
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineService({ token: _DashboardService, factory: _DashboardService.\u0275fac });
};
(() => {
...
var DashboardComponent = class _DashboardComponent {
  ...
  searchCriteriaForm = this.dashboardService.createSearchCriteriaFormNew(this.getSearchCriteria);
  ...
  constructor() {
    effect(() => {
      const data = this.getSearchCriteria.value();
      console.log("Effect triggered. Data:", data);
      this.searchCriteriaForm = this.dashboardService.createSearchCriteriaFormNew(this.getSearchCriteria);
    });
  }
  ngOnInit() {
  }
  onSearch() {
    this.searchCriteria.set(this.searchCriteriaForm.value);
    this.filteredPersonListResult.reload();
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "src/app/pages/dashboard/components/dashboard-component/dashboard-component.ts", lineNumber: 14 });
})();
export {
  DashboardComponent as default
};
//# sourceMappingURL=chunk-JTLFUX3E.js.map
