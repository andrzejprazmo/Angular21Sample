...
var DetailsComponent = class _DetailsComponent {
  ...
  personId = input.required(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "personId" } : (
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DetailsComponent, selectors: [["app-details-component"]], inputs: { personId: [1, "personId"] }, decls: 8, vars: 4, consts: [["personDetails", ""], [1, "container"], [1, "card"], [1, "card-body"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"]], template: function DetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      const personDetails_r2 = \u0275\u0275reference(7);
      \u0275\u0275advance(5);
      \u0275\u0275property("ngTemplateOutlet", personDetails_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c0, personDetails_r2));
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DetailsComponent, [{
    type: Component,
    args: [{ selector: "app-details-component", imports: [CommonModule], template: '<div class="container">\n    <h1>Details</h1>\n    <div class="card">\n        <div class="card-body">\n            <ng-container [ngTemplateOutlet]="personDetails" [ngTemplateOutletContext]="{ $implicit: personDetails }"></ng-container>\n        </div>\n    </div>\n</div>\n\n<ng-template #personDetails let-person>\n    <div><em>First name:</em> <strong>{{ person.firstName }}</strong></div>\n    <div><em>Last name:</em> <strong>{{ person.lastName }}</strong></div>\n\n</ng-template>' }]
...
//# sourceMappingURL=chunk-RUG33XN3.js.map
